...
import 'package:second_project/screens/widget/taskTime2.dart';
...
class TaskInfo2 extends StatelessWidget {

  // final List<TaskModel>? myTask = tasks;
  DateTime _selecteddate=DateTime.now();
  DatePickerController? controller;
  TextEditingController controllerTaskName1 = TextEditingController();
  TextEditingController controllerTaskStartingTime1 = TextEditingController();
  TextEditingController controllerTaskEndingTime1 = TextEditingController();
  TextEditingController controllerTaskSlot1 = TextEditingController();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        centerTitle: true,
        title:  Text('Chores Task',style :GoogleFonts.caveat(
            fontSize: 30
        )),
      ...
      body: CustomScrollView(
        slivers: [
          ...
          Provider.of<DbProvider>(context).TaskList2.length == 0?SliverFillRemaining(
            child: Container(
                color: Colors.white,
                child: Center(child: Lottie.asset('assets/animation/em.json'))),
          ):SliverList(delegate: SliverChildBuilderDelegate(
                  (context,index)=>TaskTimeLine2(Provider.of<DbProvider>(context).TaskList2[index],greenSet),
              childCount:  Provider.of<DbProvider>(context).TaskList2.length
          )),
        ],
      ),
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: Form(
                              ...
                              child: Column(
                                children: [
                                  TextFormFieldWidget(title: 'Task Name :',controller:controllerTaskName1,validator: requiredValidator,),
                                  SizedBox(height: 15,),
                                  TextFormFieldWidget(title: 'Starting Time :',controller:controllerTaskStartingTime1,validator: clockValidation,),
                                  SizedBox(height: 15,),
                                  TextFormFieldWidget(title: 'Ending Time :',controller:controllerTaskEndingTime1,validator: clockValidation,),
                                  SizedBox(height: 15,),
                                  TextFormFieldWidget(title: 'slot :',controller:controllerTaskSlot1,validator: slotValidation,),
                                  SizedBox(height: 15,),
                                  Container(
                                      decoration: BoxDecoration(
                                      ...
                                      child: IconButton(
                                          onPressed: ()async{
                                            DescModel descModel = DescModel(title: controllerTaskName1.text, startTime: controllerTaskStartingTime1.text, endTime: controllerTaskEndingTime1.text, slot: controllerTaskSlot1.text);
                                            await Provider.of<DbProvider>(context, listen: false).createNewTask2(descModel);
